# study-note 전체 색인 (2026-09-20 기준)
...
| [history](history/) | 기술 변천사 — 왜 지금 모양이 되었나(읽는 문서) | 8주제 75편 (database·web·network·js·rust·python·spring·java) | [history/README.md](history/README.md) |
