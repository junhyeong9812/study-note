...
|---|---|
| 모든 호출 횟수 · 동일성 격자 14칸 · `defaultPrevented` 값 · 예외 이름과 문구 · 콘솔 경고의 줄 수(두 줄 — 단 호출 수와 다르다, A8) | — |
...
| 콘솔 경고 문구와 **줄 수** | 두 줄 | ★ 기본 passive + 합성 조합의 침묵은 Chrome 의 것이다([19번 주제](../19-passive-and-scroll/2-summary.md)의 (6)) |
