...
**「배열 멤버냐 포인터 멤버냐」가 복사의 깊이를 가른다** — 그 선택은 [목록의 **38번 주제**](../38-expressing-ownership-conventions-in-code/)(소유권)가 정본이다.
...
- [목록의 **38번 주제**](../38-expressing-ownership-conventions-in-code/) (소유권 관례) — **포인터 멤버를 둘 때** 누가 해제하나
