...
> **이어지는 곳** — [15 — 프로토타입 체인](../15-prototype-chain/2-summary.md) · [목록의 **18번 주제**](../18-for-in-and-enumeration/) 「`for...in` 과 열거」 · [목록의 **25번 주제**](../25-array-non-mutating-and-copy-methods/) 「배열 비변형·복사 메서드」 · [목록의 **27번 주제**](../27-object-static-methods/) 「`Object` 정적 메서드」 · 목록의 **35번 주제** 「엄격 모드」 · 목록의 **45번 주제** 「`Proxy`」 · 목록의 **46번 주제** 「`Reflect`」 · 목록의 **48번 주제** 「깊은 복사 수단 비교」
>
...
- 목록의 **48번 주제** 「깊은 복사 수단 비교」 — **그쪽이 깊은 동결·깊은 복사의 정본**이다. 여기는 **얕다는 사실**까지.
