...
> **이어지는 곳** — [15 — 프로토타입 체인](../15-prototype-chain/2-summary.md) · 목록의 **18번 주제** 「`for...in` 과 열거」 · 목록의 **25번 주제** 「배열 비변형·복사 메서드」 · 목록의 **27번 주제** 「`Object` 정적 메서드」 · 목록의 **35번 주제** 「엄격 모드」 · 목록의 **45번 주제** 「`Proxy`」 · 목록의 **46번 주제** 「`Reflect`」 · 목록의 **48번 주제** 「깊은 복사 수단 비교」
>
