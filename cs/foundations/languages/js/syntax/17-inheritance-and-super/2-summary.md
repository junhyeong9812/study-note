...
> **이어지는 곳** — [18 — `for...in` 과 열거](../18-for-in-and-enumeration/2-summary.md) · 목록의 **22번 주제** 「`Symbol` 과 잘 알려진 심볼」 · 목록의 **32번 주제** 「오류 처리와 `Error`」 · 목록의 **34번 주제** 「타입 검사 관용구」 · 목록의 **45번 주제** 「`Proxy`」 · 목록의 **46번 주제** 「`Reflect`」
>
...
- 목록의 **22번 주제** 「`Symbol` 과 잘 알려진 심볼」 — **그쪽이 `Symbol.species` 를 포함한 잘 알려진 심볼 전체의 정본**이다.
