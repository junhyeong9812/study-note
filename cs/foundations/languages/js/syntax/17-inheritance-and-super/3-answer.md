...
- **필드 초기화 순서** → 16번 · **조회와 수신자 규칙** → 15번 · **`this` 판정** → 07번 · **잘 알려진 심볼 전체** → 목록의 **22번 주제** ·
  **`Error` 의 `cause` 쓰임** → 목록의 **32번 주제** · **`instanceof` 대 `Array.isArray`** → 목록의 **34번 주제** · **트랩의 `receiver`** → 목록의 **45번 주제**·**46번 주제**.
