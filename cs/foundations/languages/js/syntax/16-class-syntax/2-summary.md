...
> 목록의 **34번 주제** 「타입 검사 관용구」 · 목록의 **35번 주제** 「엄격 모드」 · 목록의 **45번 주제** 「`Proxy`」
>
...
- 목록의 **35번 주제** 「엄격 모드」 — **그쪽이 엄격 모드가 바꾸는 규칙 전체의 정본**이다. 여기는 **클래스 몸통이 늘 엄격**이라는 것까지.
- 목록의 **45번 주제** 「`Proxy`」 — **그쪽이 트랩 계약의 정본**이다. 여기는 **`#x` 가 트랩에 안 걸린다**까지.
