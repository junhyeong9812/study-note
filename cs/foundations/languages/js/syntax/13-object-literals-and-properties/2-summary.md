...
> **이어지는 곳** — [14 — 프로퍼티 디스크립터와 동결](../14-property-descriptors-and-freezing/2-summary.md) · [15 — 프로토타입 체인](../15-prototype-chain/2-summary.md) · [목록의 **18번 주제**](../18-for-in-and-enumeration/) 「`for...in` 과 열거」 · [목록의 **22번 주제**](../22-symbol-and-well-known-symbols/) 「`Symbol` 과 잘 알려진 심볼」 · [목록의 **27번 주제**](../27-object-static-methods/) 「`Object` 정적 메서드」
>
...
- [목록의 **18번 주제**](../18-for-in-and-enumeration/) 「`for...in` 과 열거」 — **그쪽이 체인 순회의 정본**이다.
- [목록의 **22번 주제**](../22-symbol-and-well-known-symbols/) 「`Symbol` 과 잘 알려진 심볼」 — **그쪽이 심볼의 정본**이다.
