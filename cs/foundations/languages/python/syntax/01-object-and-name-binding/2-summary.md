...
- 이어지는 곳: [목록의 **21번 주제**](../21-scope-legb-global-nonlocal/) 「스코프 LEGB 와 `global`·`nonlocal`」 · [목록의 **22번 주제**](../22-closures-and-late-binding/) 「클로저와 늦은 바인딩」 — 이 절의 LEGB 를 **클로저 설계**까지 끌고 간다.
