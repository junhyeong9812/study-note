...
> 1단계 리스트업이다. 아래 주제들의 3파일(질문·서머리·정답)은 **01\~08 만 있고 나머지는 아직 없다**(2026-09-25 첫 배치 — `01-document-skeleton`·`02-elements-and-attributes`·`03-parser-and-error-recovery`·`04-whitespace-and-character-references`).\
