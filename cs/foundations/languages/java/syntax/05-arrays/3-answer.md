...
- 대신 필요할 때만 여는 장치로 **와일드카드**(`? extends` / `? super`)를 뒀다([**18번 주제**](../18-wildcards-pecs/)).
...
- "불변"과 "수정 불가 뷰"의 차이는 [**40번 주제**](../40-list-set-and-immutable-factories/)가 정본이다.
...
- 정본은 [**19번 주제**](../19-type-erasure/)(타입 소거)다.
