...
- [목록의 **12번 주제**](../12-class-basics-members-access-and-this/)(클래스 기본·접근 지정) — `friend` 의 **접근 제어** 쪽 의미.
- [목록의 **22번 주제**](../22-operator-overloading/)(연산자 오버로딩) — 「멤버냐 비멤버냐」를 (3)의 숨은 `friend` 로 푸는 설계.
- [목록의 **31번 주제**](../31-function-templates-and-argument-deduction/)(함수 템플릿) — 2단계 관용구가 **템플릿 안에서** 왜 필요한지.
