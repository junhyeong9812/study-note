...
- [목록의 **31번 주제**](../31-function-templates-and-argument-deduction/)(함수 템플릿) — 템플릿이 후보에 섞이면 규칙이 한 겹 늘어난다.
...
- **템플릿이 섞이면** — 비템플릿이 템플릿과 동점이면 **비템플릿이 이긴다.** 템플릿끼리는 **더 특수한 쪽**이 이긴다. [목록의 **31번 주제**](../31-function-templates-and-argument-deduction/).
