...
> 「공유 소유와 제어 블록」은 [27번](../27-shared-ptr-and-reference-counting/), 「`weak_ptr` 와 순환」은 목록의 **28번 주제**, 「`new`/`delete` 와 raw 포인터가 남는 자리」는 목록의 **29번 주제**다.
>
> ★★ **흔들리는 칸 / 안 흔들리는 칸**
>
...
- ★★ **원시 포인터(`d.get()`)는 관찰** — 소유권·수명과 **무관**하다. 함수가 저장해 두면 **댕글링**이 될 수 있다(목록의 **29번 주제**).
