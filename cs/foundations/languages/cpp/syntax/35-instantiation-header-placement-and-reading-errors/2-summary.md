...
> **경계** — 「ODR 일반과 모듈」은 목록의 **55번 주제**, 「컨셉 문법과 표준 컨셉」은 목록의 **36번 주제**, 「C 의 헤더 배치 규칙」은 C 갈래 44번이, 「링커 일반」은 [`compiler-pipeline/`](../../../../compiler-pipeline/)이 정본이다. 여기서 컨셉은 **오류가 어디로 옮겨 가나**만 본다.
>
> ★★ **흔들리는 칸 / 안 흔들리는 칸**
>
...
**언제 쓰나** — 내가 쓴 템플릿의 오류를 **쓰는 사람의 자리**로 끌어오고 싶을 때. 컨셉 자체의 정본은 목록의 **36번 주제**다.
...
| 내 템플릿의 오류를 쓰는 사람 자리로 | ★★★ **컨셉 제약**(목록의 **36번 주제**) | (7) — 자리가 호출 줄로 |
...
- 목록의 **36번 주제**(컨셉) · 목록의 **55번 주제**(모듈·ODR).
