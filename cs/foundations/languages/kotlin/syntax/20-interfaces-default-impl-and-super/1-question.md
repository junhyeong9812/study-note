...
> `sealed interface` 와 `when` 완결성은 [목록의 **23번 주제**](../23-sealed-classes-and-when-exhaustiveness/), `fun interface` 는 [목록의 **36번 주제**](../36-function-types-fun-interface-and-sam-conversion/)가 정본이다.
