...
- [목록의 **36번 주제**](../36-function-types-fun-interface-and-sam-conversion/)(함수 타입·`fun interface`·SAM 변환) — 람다를 객체로 받는 **다른 길**
- [목록의 **47번 주제**](../47-sequences-lazy-evaluation/)(`Sequence`) — 인라인이 **안 되는** 고차 함수 사슬의 대표
