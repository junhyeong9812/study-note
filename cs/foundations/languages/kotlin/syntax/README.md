...
> 진행 — **21 / 58**(01 \~ 21). 「주제」 칸의 링크가 각 주제의 3파일 폴더다.
...
| 14 | [scope function 5종 — `let`/`run`/`with`/`apply`/`also`](14-scope-functions/) | 문법 | 수신자 형태(`this`/`it`)와 반환값(수신자/람다 결과)으로 다섯을 구분해 고를 수 있다 | 10, 13 | — | A |
