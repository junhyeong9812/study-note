...
큰 표에서는 계획을 확인한다(목록의 [**46**](../46-index-definition-composite-partial-expression/)·[**47**](../47-when-indexes-are-used/)·[**58**](../58-explain-plan-tree/)번 주제).
...
MVCC 의 정본은 [목록의 **56번 주제**](../56-isolation-levels-read-phenomena-mvcc/)다.
