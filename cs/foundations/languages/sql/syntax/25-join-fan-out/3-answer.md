...
★ **경계: 계획 읽기 자체는 [목록의 **58번 주제**](../58-explain-plan-tree/), 연산자 이름(`Hash Left Join` 등)은 59번 주제, 추정 대 실측의 격차는 60번 주제다.**\
...
제약 정의는 [목록의 **43번 주제**](../43-primary-key-unique-and-null/)다. **「짝이 있는지만」 보면 되는 경우에는 `EXISTS` 가 행을 아예 안 늘린다**([목록의 **19번 주제**](../19-semi-anti-join/)).
