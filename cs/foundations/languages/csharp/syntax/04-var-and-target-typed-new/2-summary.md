...
> **컬렉션 식 `[1, 2, ..other]`**(C# 12)은 목록의 **11번 주제**다.
>
> ★★ **흔들리는 칸 / 안 흔들리는 칸**
>
...
- 목록의 **11번 주제**(컬렉션 초기화와 컬렉션 식) — `[1, 2, ..other]`(C# 12)가 **타겟 타입이 필요한 또 하나의 식**이다.
...
- **컬렉션 식 `[1, 2]`**(C# 12) — `new()` 와 같은 「타겟이 필요한 식」 집안. ★ 안 던졌다(목록의 **11번 주제**).
