...
- 고치는 법 — `strconv.Itoa(n)`. [목록의 **11번 주제**](../11-strings-strconv-bytes-and-unicode-utf8/)가 정본이다.
...
| 유니코드 코드포인트 | `rune`(= `int32`) | 〃 ([목록의 **10번 주제**](../10-strings-bytes-runes-and-utf8-iteration/)) |
