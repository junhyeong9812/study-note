...
- ★ 그래서 「빈 슬라이스를 돌려주려고 `[]int{}` 를 만들」 이유가 거의 없다.
  ...
  그 정본은 [목록의 **45번 주제**](../45-encoding-json-tags-omitempty-pointers-numbers-and-streaming/)다.
...
| 인덱스 검사의 실행 비용 | **안 쟀다.** 재려면 벤치마크가 따로 필요하다([목록의 **50번 주제**](../50-benchmarks-testing-b-and-reading-profiles/)) |
