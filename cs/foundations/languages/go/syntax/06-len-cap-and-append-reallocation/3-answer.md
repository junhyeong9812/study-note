...
- **「미리 잡으면 빠르다」** 를 주장하려면 **벤치마크**가 필요하다 — 정본은 [목록의 **50번 주제**](../50-benchmarks-testing-b-and-reading-profiles/)다.
...
- **`slices.Grow`·`slices.Clip`** — [목록의 **38번 주제**](../38-slices-maps-and-cmp/). 둘 다 **1.21**부터다.
- **가변 인자 `x...`** — [목록의 **12번 주제**](../12-functions-multiple-returns-named-results-and-variadics/).
- **벤치마크로 수치를 주장하는 법** — [목록의 **50번 주제**](../50-benchmarks-testing-b-and-reading-profiles/).
...
| **「미리 잡으면 빠르다」** | **안 쟀다.** 잰 것은 재할당 **횟수**까지다([목록의 **50번 주제**](../50-benchmarks-testing-b-and-reading-profiles/)) |
