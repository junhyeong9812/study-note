...
비용 — 오버로드 해석은 **위에서부터 맞는 것을 고른다.** 순서에 뜻이 생긴다 — 전면 서술은 [목록의 **16번 주제**](../16-function-types-and-overloads/)다.
...
- [목록의 **16번 주제**](../16-function-types-and-overloads/)(함수 타입과 오버로드) — 오버로드 해석 순서와 구현 시그니처는 그쪽.
- [목록의 **24번 주제**](../24-conditional-types-and-distribution/)(조건부 타입과 분배) — 「분배」라는 말이 조건부 타입에서 다시 나온다. **같은 말, 다른 규칙**이다.
- [목록의 **28번 주제**](../28-utility-types/)(유틸리티 타입) — `Omit` 으로 충돌 키를 빼는 관용구는 그쪽.
