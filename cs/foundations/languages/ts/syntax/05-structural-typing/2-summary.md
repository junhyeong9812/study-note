...
- [목록의 **30번 주제**](../30-type-assertions-and-non-null/)(타입 단언과 non-null `!`) — `as` 의 위험은 그쪽. 브랜드의 관문 함수가 그 위에 서 있다.
- [목록의 **32번 주제**](../32-class-type-aspects/)(클래스의 타입 측면) — `private` 대 `#` 의 전면 비교는 그쪽.
