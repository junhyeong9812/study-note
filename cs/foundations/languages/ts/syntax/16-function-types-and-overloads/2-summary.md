...
| 좁은 꼴을 **먼저** 적을 수 있을 때 | 순서를 지키기 어려운 조합 — 조건부 타입이 낫다(목록의 **24번 주제**) |
...
- 목록의 **24번 주제**(조건부 타입과 분배) — 「인자에 따라 반환이 갈린다」를 오버로드 대신 조건부 타입으로 쓰는 길.
...
- **조건부 타입이라는 대안** — 「인자에 따라 반환이 갈린다」는 조건부 타입으로도 쓸 수 있다. 오버로드는 **읽기 쉽고 순서에 취약**하고, 조건부 타입은 **순서에 안 취약하고 읽기 어렵다.** 목록의 **24번 주제**에서 다룬다 — **이 배치에서는 안 던졌다.**
