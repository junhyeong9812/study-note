...
| 조합이 많아 순서를 지키기 어렵다 | 조건부 타입 | [목록의 **24번 주제**](../24-conditional-types-and-distribution/). **안 던졌다** |
...
- **제네릭 오버로드** — 타입 매개변수가 붙은 오버로드는 **안 던졌다.** [목록의 **19번 주제**](../19-generics-basics/).
- **조건부 타입으로 같은 일을 하는 판** — [목록의 **24번 주제**](../24-conditional-types-and-distribution/). **안 던졌다.**
- **`this` 매개변수가 붙은 시그니처** — [목록의 **18번 주제**](../18-this-parameter-types/). **안 던졌다.**
