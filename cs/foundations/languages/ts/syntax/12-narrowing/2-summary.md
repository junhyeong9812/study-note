...
- [목록의 **14번 주제**](../14-assertion-signatures/)(단언 시그니처 `asserts`) — 좁힘을 **함수가 단언**하게 만드는 길.
- [목록의 **15번 주제**](../15-control-flow-analysis-limits/)(제어 흐름 분석의 한계) — 4절의 전면 서술은 그쪽이다. 여기서는 **일곱 자리를 던져 본 것**까지.
- [목록의 **40번 주제**](../40-strict-null-checks-ripple/)(`strictNullChecks` 의 파급) — 5절의 전면 서술은 그쪽.
