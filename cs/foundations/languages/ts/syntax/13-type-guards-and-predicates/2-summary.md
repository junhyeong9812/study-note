...
비용 — ★★★ **술어 하나가 그 타입의 안전을 통째로 책임진다.** 단언(`as`)과 같은 등급의 탈출구다([목록의 **30번 주제**](../30-type-assertions-and-non-null/)).
...
- [목록의 **30번 주제**](../30-type-assertions-and-non-null/)(타입 단언과 non-null `!`) — 거짓 술어가 `as` 와 **같은 등급의 탈출구**라는 것은 그쪽과 함께 읽는다.
