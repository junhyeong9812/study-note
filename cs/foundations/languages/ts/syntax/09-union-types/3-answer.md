...
- ★ 피하는 길은 **`string` 을 안 섞는 것**이다. 자동완성을 살리는 관용구는 [목록의 **11번 주제**](../11-literal-types-and-as-const/)에서 다룬다.
...
- **유니온 크기에 따른 검사 시간** — 「더 들어가면」의 마지막 줄. **재지 않았고 수치를 적지 않았다.** [목록의 **45번 주제**](../45-type-level-performance/)에서 잰다.
- `"asc" | "desc" | (string & {})` 관용구 — [목록의 **11번 주제**](../11-literal-types-and-as-const/)에서 던진다. 여기서는 **형태만** 적었다.
