...
2014년 3월 출시를 앞둔 Java 8은 **람다 표현식·메서드 참조·`java.time`(JSR-310)·`Optional`**이라는 대형 언어 변화를 예고하고 있었다.\
Spring 4.0(2013-12)은 출시 전 Java 8 빌드를 기준으로 이 변화에 맞춰 코드베이스를 미리 정비해 Java 8을 1급으로 지원했고, Java 8 GA 직후의 4.0.3(2014-03)에서 그 지원이 production-ready가 됐다.\
